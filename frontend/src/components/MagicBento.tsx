...
const DEFAULT_GLOW_COLOR = '251, 203, 151';
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  return (
      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgb(231, 138, 83);
            --purple-glow: rgb(231, 138, 83);
            --purple-border: rgb(231, 138, 83);
          }
    ...
    --purple-glow: rgba(var(--primary), 0.2);
    --purple-border: rgba(var(--primary), 0.8);
  }
  ...
  .card--border-glow:hover {
    box-shadow: 0 4px 20px rgba(46, 24, 78, 0.4), 0 0 30px rgba(var(--primary), 0.2);
  }
